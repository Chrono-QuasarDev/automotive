    ...
    <Router>
      <div className="min-h-screen bg-brand-black text-brand-white flex flex-col">
        ...
        >
          ...
          {/* Tooltip */}
          <span className="absolute right-full mr-3 bg-brand-charcoal text-brand-white text-xs font-medium px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-lg">
            Chat with us
          </span>
        </a>
      </div>
